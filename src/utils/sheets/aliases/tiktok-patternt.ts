export const TikTokProductPattern = [
  {
    productId: 60,
  ...
  },
  {
    ...
    priority: 100,
    aliases: [/classic wooden toy game/i, /เกมส์การ์ดโยนลูกเต๋า/i],
    inlineVariant: {
      colorPatterns: [],
      sizePatterns: [],
    },
  ...
  },
  {
    ...
    inlineVariant: {
      colorPatterns: [
        { colorId: 10, color: "6-point", patterns: [/\b6\b/i, /6 จุด/i] },
        { colorId: 11, color: "9-point", patterns: [/\b9\b/i, /9 จุด/i] },
        {
          colorId: 12,
          color: "12-point",
          patterns: [/12/i, /12 จุด/i],
        },
      ],
      sizePatterns: [
        {
  ...
  },
  {
    ...
    externalVariant: {
      colorPatterns: [
        { colorId: 4, color: "Orange", patterns: [/\bL\b/i] },
        { colorId: 2, color: "Blue", patterns: [/\bM\b/i] },
        { colorId: 3, color: "Green", patterns: [/\bS\b/i] },
      ],
      sizePatterns: [
        { sizeId: 2, size: "M", patterns: [/\bM\b/i] },
        { sizeId: 3, size: "L", patterns: [/\bL\b/i] },
  ...
  // #endregion ****
  {
    ...
    priority: 50,
    aliases: [/magnetic backgammon/i, /แบ็กแกมมอนแม่เหล็ก/i],
    inlineVariant: {
      colorPatterns: [],
      sizePatterns: [],
    },
  ...
  },
  {
    ...
    priority: 100,
    aliases: [/jackpot 6 players/i, /เกมไม้ปิดกล่องสำหรับ 2-6 คน/i],
    inlineVariant: {
      colorPatterns: [],
      sizePatterns: [],
    },
  ...
  {
    productId: 63,
    productName: "Heart Tangram Puzzle",
    priority: 50,
    aliases: [/heart tangram puzzle/i, /บล็อกตัวต่อหัวใจ/i],
    inlineVariant: {
      colorPatterns: [],
      sizePatterns: [],
    },
